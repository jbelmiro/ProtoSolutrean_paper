...
```{r corebloxplotVB, fig.cap="Vale Boi. Boxplots of core elongation and flattening by raw material and phase.", out.width='80%', fig.align='center', echo=FALSE, include=FALSE}
...
```{r flakeboxplot, fig.cap="Vale Boi. Boxplots of flake elongation and flattening by raw material and phase.", echo=FALSE, include=FALSE, fig.align= 'center', out.width = '80%', fig.pos="H"}
...
```{r corebloxplotLP, fig.cap="Lapa do Picareiro. Boxplots of core elongation and flattening by raw material and phase.", echo=FALSE, fig.align= 'center', out.width = '60%', fig.pos="H", include=FALSE}
coreB_LP <- datasetlp %>% 
  filter(Class=="Core") %>% 
  mutate(CoreElongation=Length/MaxWidth) %>% 
  mutate(CoreFlattening=MaxWidth/Thickness) %>% 
...
```{r flakeboxplotLP, fig.cap="Lapa do Picareiro. Flake elongation and flattening by phase and raw material.", echo=FALSE, include=FALSE, fig.align= 'center', out.width = '80%'}
...
```{r quartzbladelet, fig.cap="Lapa do Picareiro - U/Lower T - Fine quartz and rock crystal blanks and blank fragments.", out.width = '60%', fig.align='center', echo=FALSE, fig.pos="H", include=FALSE}
...
```{r corelower, echo = FALSE, fig.cap = "Vale Boi - Lower 5. Chert and iron oxide (upper right) cores with vectorized scar negatives and scar directionality.", fig.align= 'center', out.width = '80%', fig.pos="H", include=FALSE}

knitr::include_graphics(here::here("analysis/figures/coreL.jpg"))

```

```{r coreupper, echo = FALSE, fig.cap = "Vale Boi - Upper 5/4E. Chert cores with vectorized scar negatives and scar directionality.", fig.align= 'center', out.width = '80%', fig.pos="H", include=FALSE}
...
```{r vct, fig.cap="Vale Boi - Vale Comprido points in dolerite, chert and chalcedony.", out.width = '70%', fig.align='center', echo=FALSE, include=FALSE}

knitr::include_graphics(here::here("analysis/figures/prancha_vct.jpg"))

```

```{r vct2, fig.cap="Vale Boi - Vale Comprido points in dolerite.", out.width = '60%', fig.align='center', echo=FALSE, include=FALSE}

knitr::include_graphics(here::here("analysis/figures/prancha_vct2.jpg"))

```

```{r lpblades, fig.cap="Lapa do Picareiro - Middle T - Chert blades with similarities to Vale Comprido technology.", out.width = '60%', fig.align='center', echo=FALSE, include=FALSE}
